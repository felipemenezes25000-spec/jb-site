...
export function ResumoPix({ simulado }: { simulado?: boolean }) {
  ...
  return (
    <div className="rounded-xl border border-graf-200 bg-graf-50 p-4 sm:p-5">
      ...
      <ol className="mt-4 space-y-3 text-sm leading-relaxed text-graf-700">
        {passos.map((passo, i) => (
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-6 sm:grid-cols-[auto_minmax(0,1fr)] sm:items-start sm:gap-8">
        {imagem ? (
          ...
          <div className="mx-auto flex size-[200px] flex-col items-center justify-center gap-2.5 rounded-xl border border-dashed border-graf-300 bg-graf-50 p-4 text-center sm:mx-0">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-2xl font-extrabold tabular tracking-tight text-graf-950">
          ...
          <ol className="mt-6 space-y-2 border-t border-graf-200 pt-5 text-sm leading-relaxed text-graf-700">
            <li>1. Abra o app do seu banco e escolha Pix.</li>
            <li>2. {imagem ? "Leia o QR Code ou cole o código." : "Use “Pix copia e cola”."}</li>
            <li>3. Confira o valor e conclua o pagamento.</li>
          </ol>
