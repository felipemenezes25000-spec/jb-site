...
export function SecaoAssistencia({ configuracoes: s }: { configuracoes: SettingsMap }) {
  ...
  return (
    <section className="relative isolate overflow-hidden border-y border-graf-100 bg-[#fffdfc] py-16 min-[768px]:py-20 min-[1024px]:py-24 min-[1440px]:py-28">
      {/* Fundo: luz quente, arcos finos e o consultório entrando pela esquerda. */}
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_72%_8%,rgba(221,24,32,0.07),transparent_28%),radial-gradient(circle_at_4%_62%,rgba(221,24,32,0.05),transparent_26%),linear-gradient(120deg,rgba(255,255,255,0.96),rgba(255,249,248,0.9))]"
        aria-hidden
      />
      <div
      ...
      <div
        className="pointer-events-none absolute -left-6 top-0 hidden h-[19rem] w-[6rem] opacity-70 min-[1440px]:block"
        aria-hidden
      >
        <Image
      ...
      <div
        className="pointer-events-none absolute bottom-0 left-0 hidden w-[clamp(11rem,15vw,17rem)] opacity-90 min-[1280px]:block"
        aria-hidden
      >
        <Image
          ...
          width={260}
          height={566}
          sizes="(min-width: 1600px) 272px, 200px"
          className="h-auto w-full object-contain"
        />
      </div>

      <p
        className="pointer-events-none absolute left-[5.5rem] top-[11rem] hidden text-[0.62rem] font-semibold uppercase leading-[1.9] tracking-[0.3em] text-graf-400 min-[1600px]:block"
        aria-hidden
      >
        Equipamentos
        <br />
      ...
      <div
        className="pointer-events-none absolute right-[4.6rem] top-[3.4rem] hidden -rotate-[7deg] text-right text-[1.35rem] leading-[1.1] text-graf-500 min-[1600px]:block"
        style={CURSIVA}
        aria-hidden
      >
        Tecnologia
      ...
      <div className="container-jb relative z-10 max-w-[112rem] min-[1600px]:pl-[9rem]">
        {/* ── Cabeçalho editorial ─────────────────────────────────────────── */}
        <div className="grid gap-8 min-[1024px]:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] min-[1024px]:items-end min-[1024px]:gap-x-14 min-[1440px]:gap-x-20">
          <div>
            ...
            <h2 className="mt-4 max-w-[14ch] text-[clamp(2.75rem,4.8vw,5.9rem)] font-black leading-[0.9] tracking-[-0.062em] text-graf-950">
          ...
          <div className="min-[1024px]:pb-4">
            <p className="max-w-[34rem] text-[clamp(1rem,1.25vw,1.22rem)] leading-[1.5] text-graf-500">
        ...
        {/* ── Dois caminhos ───────────────────────────────────────────────── */}
        <div className="mt-9 grid gap-4 min-[1024px]:grid-cols-[minmax(0,0.88fr)_minmax(0,1fr)] min-[1024px]:gap-5">
          <article className="relative min-h-[25rem] overflow-hidden rounded-[2rem] border border-graf-200 bg-white shadow-[0_30px_70px_-50px_rgba(70,0,0,0.38)] min-[640px]:min-h-[26.5rem] min-[1440px]:rounded-[2.1rem]">
            <div
            ...
            <div className="absolute -right-16 -top-16 size-56 rounded-full border border-jb-200/60" aria-hidden />

            <div
              className="pointer-events-none absolute bottom-0 right-0 hidden h-[82%] w-[13rem] min-[640px]:block min-[1280px]:w-[15.5rem]"
              aria-hidden
            >
              <Image
                ...
                alt=""
                fill
                sizes="(min-width: 1280px) 248px, 208px"
            ...
            <div className="relative z-10 flex min-h-[25rem] max-w-[70%] flex-col p-7 min-[640px]:min-h-[26.5rem] min-[640px]:p-9 min-[1024px]:p-10">
              ...
              <p className="mt-7 text-[0.67rem] font-black uppercase tracking-[0.18em] text-jb-700">
                Quero comprar
              </p>
              <h3 className="mt-2 max-w-[11ch] text-[clamp(1.9rem,2.7vw,3.15rem)] font-black leading-[0.95] tracking-[-0.05em] text-graf-950">
              ...
              <div className="mt-auto flex flex-col gap-3 pt-7 min-[640px]:flex-row min-[640px]:flex-wrap">
                <LinkBotao
                  href="/loja"
                  tamanho="lg"
          ...
          <article className="relative min-h-[25rem] overflow-hidden rounded-[2rem] bg-[#101012] text-white shadow-[0_34px_78px_-42px_rgba(31,0,0,0.7)] min-[640px]:min-h-[26.5rem] min-[1440px]:rounded-[2.1rem]">
            <div
              className="absolute inset-0 bg-[linear-gradient(125deg,#111113_0%,#151214_52%,#1d0709_100%)]"
              aria-hidden
            />

            <div
              className="pointer-events-none absolute bottom-0 right-0 hidden h-full w-[62%] min-[640px]:block"
              aria-hidden
            >
              <Image
                ...
                alt=""
                fill
                sizes="(min-width: 1024px) 560px, 380px"
                className="object-cover object-right-bottom"
              />
            </div>

            <div
              className="absolute inset-0 bg-[radial-gradient(circle_at_86%_44%,rgba(244,25,35,0.28),transparent_26%),radial-gradient(circle_at_68%_4%,rgba(143,5,12,0.24),transparent_34%),linear-gradient(90deg,#101012_0%,rgba(16,16,18,0.92)_34%,transparent_62%)]"
              aria-hidden
            />
            <div className="absolute -right-36 -top-36 size-[30rem] rounded-full border border-jb-500/50" aria-hidden />
            <div className="absolute -right-16 -top-16 size-[21rem] rounded-full border border-jb-500/20" aria-hidden />
            ...
            <div className="relative z-10 flex min-h-[25rem] max-w-[68%] flex-col p-7 min-[640px]:min-h-[26.5rem] min-[640px]:p-9 min-[1024px]:p-10">
              ...
              <p className="mt-7 text-[0.67rem] font-black uppercase tracking-[0.18em] text-jb-300">
                Preciso de suporte
              </p>
              <h3 className="mt-2 max-w-[10ch] text-[clamp(1.9rem,2.7vw,3.15rem)] font-black leading-[0.95] tracking-[-0.05em] text-white">
        ...
        {/* ── Fechamento ──────────────────────────────────────────────────── */}
        <div className="relative mt-6 flex flex-col items-center justify-center gap-2 text-center text-xs leading-relaxed text-graf-500 min-[640px]:flex-row">
