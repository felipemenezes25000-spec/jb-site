    ...
    <Secao fundo="clara" largura="loja" espaco="md" separador>
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:items-end">
        <div className="max-w-2xl">
          <p className="sobretitulo mb-3">Compra e suporte</p>
          <h2 className="text-section texto-forte">
            Dois caminhos claros para o que sua clínica precisa agora.
          </h2>
        </div>
        <p className="texto-guia texto-suave max-w-2xl lg:justify-self-end">
      ...
      <ol className="mt-4 grid overflow-hidden rounded-xl border border-graf-200 bg-white sm:grid-cols-3">
        {ETAPAS.map((etapa) => (
          <li key={etapa.numero} className="min-w-0 border-b border-graf-200 p-4 last:border-b-0 sm:border-b-0 sm:border-r sm:last:border-r-0 sm:p-5">
            <p className="sobretitulo">{etapa.numero} · {etapa.rotulo}</p>
