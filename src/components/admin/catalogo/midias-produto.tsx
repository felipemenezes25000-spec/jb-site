                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {indice === 0 ? (
                      ...
                      <button
                        ...
                        className={cn(
                          "inline-flex min-h-11 items-center gap-1.5 rounded-lg px-2 text-xs font-semibold text-graf-600",
                    ...
                    <span className="truncate text-xs text-graf-500">{foto.nome}</span>
                  </div>
