  ...
  return (
    <Cartao className="w-full max-w-lg p-7 sm:p-9">
      <form action={acao}>
        ...
        <span className="flex size-12 items-center justify-center rounded-full bg-jb-50 text-jb-600 ring-1 ring-inset ring-jb-100">
          <KeyRound className="size-5" aria-hidden />
        </span>

        <p aria-hidden className="label-mono mt-6 uppercase text-graf-500">
          Chamado
        </p>
        <h1 className="tabular mt-1 font-mono text-2xl font-bold tracking-tight text-graf-950">
        ...
        <p className="mt-6 border-t border-graf-200 pt-5 text-sm leading-relaxed text-graf-500">
          Tem conta na JB?{" "}
          <Link
