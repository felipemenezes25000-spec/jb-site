                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          {unidade.notes ? (
                            <p className="mt-2 whitespace-pre-line text-apoio leading-relaxed text-graf-500">
                              {unidade.notes}
                            </p>
                          ) : null}

                          <p className="mt-2 flex items-center gap-1.5 text-apoio text-graf-500">
                ...
                <ul className="space-y-2 text-sm text-graf-700">
                  {enderecos.map((endereco) => (
                    <li key={endereco.id}>
                      ...
                      <span className="block text-apoio text-graf-500">{endereco.resumo}</span>
                    </li>
                  ))}
                </ul>
              )}
