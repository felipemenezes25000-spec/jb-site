...
- **WhatsApp que recebe:** (11) 96341-7994. Telefone alternativo continua o do site, (11) 95847-7337.
  *Atualizado em 23/09/2026:* são dois WhatsApps, cada um com quem atende: **Jeferson, (11) 96341-7994** (principal) e **Jackson, (11) 98603-8421** (o dono trocou o 95847-7337 por este). Na abertura da home e das páginas de equipamento e na chamada final, a escolha é só "Jeferson" (vermelho, principal) ou "Jackson" (branco), sem número por extenso, sem botão genérico repetido e sem "Ligar agora"; o rodapé lista os dois nomes e "Ligar para Jeferson". Cada botão abre o WhatsApp da pessoa com a saudação no nome dela. Cabeçalho, faixa do topo, barra do celular, diagnóstico e demais chamadas continuam indo para o principal. Configurações `whatsapp`/`whatsapp_nome` e `whatsapp_alternativo`/`whatsapp_alternativo_nome` (a chave `telefone_alternativo` saiu).
