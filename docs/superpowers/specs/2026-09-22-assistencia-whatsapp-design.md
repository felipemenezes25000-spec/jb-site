...
- **WhatsApp que recebe:** (11) 96341-7994. Telefone alternativo continua o do site, (11) 95847-7337.
  *Atualizado em 23/09/2026:* são dois WhatsApps, cada um com quem atende: **Jeferson, (11) 96341-7994** (principal) e **Jackson, (11) 98603-8421** (o dono trocou o 95847-7337 por este). O principal recebe a mensagem pronta de todos os botões; os dois aparecem com nome e número, cada um clicável e com a saudação no nome de quem atende, na abertura da home e das páginas de equipamento, na chamada final e no rodapé. Configurações `whatsapp`/`whatsapp_nome` e `whatsapp_alternativo`/`whatsapp_alternativo_nome` (a chave `telefone_alternativo` saiu).
