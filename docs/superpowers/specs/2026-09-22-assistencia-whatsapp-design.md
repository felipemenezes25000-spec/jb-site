...
- **WhatsApp que recebe:** (11) 96341-7994. Telefone alternativo continua o do site, (11) 95847-7337.
  *Atualizado em 23/09/2026:* são dois WhatsApps, **Jeferson, (11) 96341-7994** (principal) e **Jackson, (11) 98603-8421** (o 95847-7337 saiu). Regra do dono: **todo lugar que abre o WhatsApp mostra os dois**, pelo nome, sem número por extenso e sem botão repetido. Jeferson em vermelho, Jackson em branco, lado a lado (componente `OpcoesWhatsapp`): cabeçalho, barra do celular, abertura, diagnóstico, simulador, "Como funciona", seções, chamada final, 404 e telas de erro. A grade de equipamentos abre a escolha dentro do cartão tocado; nas páginas de equipamento o defeito é marcado antes e vai na mensagem dos dois. A faixa vermelha do topo deixou de ser link e diz "No WhatsApp: Jeferson e Jackson". O rodapé lista os dois e "Ligar para Jeferson ou Jackson". Cada botão abre o WhatsApp da pessoa com a saudação no nome dela. Configurações `whatsapp`/`whatsapp_nome` e `whatsapp_alternativo`/`whatsapp_alternativo_nome`; as telas de erro repetem os dois em `contato-de-emergencia.ts`.
